...
Every decision here is justified in pipeline/shared/tokens.py's comments; these
tests lock the resulting behaviour in.
"""
import unittest

from pipeline.shared.tokens import DYNAMIC_TOKEN_RE, TOKEN_RE, check_placeholders, corpus_to_engine
...
class GoldTokenExpansionTests(unittest.TestCase):
    ...
    def test_po_and_ke_are_deliberately_left_unmapped(self):
        ...
        # alphabet fragments, not prose -- see pipeline/shared/tokens.py's comment.
