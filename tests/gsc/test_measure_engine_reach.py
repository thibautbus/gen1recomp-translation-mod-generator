"""Unit-level check of tools/gsc/measure_engine_reach.py's categorisation logic
...
spec = importlib.util.spec_from_file_location("measure_engine_reach", ROOT / "tools" / "gsc" / "measure_engine_reach.py")
