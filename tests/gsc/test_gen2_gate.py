...
from pipeline.shared.builder import _which_luajit

ROOT = Path(__file__).resolve().parents[2]
ENGINE_ROOT = ROOT / ".cache" / "dependencies" / "gen1recomp"
FIXTURES_ROOT = ROOT / "tools" / "gsc" / "gate_fixtures"
GATE_SCRIPT = ROOT / "tools" / "gsc" / "gate.lua"


class Gen2GateTests(unittest.TestCase):
    """tools/gsc/gate.lua is the "generation = 2" loading gate `modkit
