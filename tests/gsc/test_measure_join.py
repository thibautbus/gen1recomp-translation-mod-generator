"""Guards the two normalisation traps in tools/gsc/measure_join.py: each
...
spec = importlib.util.spec_from_file_location("measure_join", ROOT / "tools" / "gsc" / "measure_join.py")
