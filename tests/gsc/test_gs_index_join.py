...
class JoinDexEntriesPagesTests(unittest.TestCase):
    ...
    def test_a_row_with_no_page_marker_at_all_still_ships_page_one(self):
        ...
        # for every other category (pipeline/shared/tokens.py); dropped here too.
...
class DecorationAttrNamesMatchTheLiveEngineTests(unittest.TestCase):
    """DECORATION_NAME_QIDS/DECORATION_ATTR_NAMES (pipeline/gsc/localized_registries.py)
