...
from pipeline.shared.corpus import read_parallel_game
from pipeline.gsc.text import GsTextRecord
from pipeline.gsc.join import (
...
class ToAlignedRowsTests(unittest.TestCase):
    ...
    def test_flows_through_the_real_validate_cli_command(self):
        # End-to-end: pipeline/shared/cli.py's `validate` command is generic over
