...
from pipeline.shared.builder import main
...
def _self_check() -> int:
    from pipeline.shared.builder import BuildError, _modkit_command, _which_luajit
    from pipeline.shared.project import is_frozen, project_config, project_version, resource_root, work_root
