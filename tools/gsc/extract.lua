...
--
-- Usage: luajit tools/gsc/extract.lua <gen1recomp_root> <rom_path> <out_dir> <edition> [engine_profile]
--
-- <edition> is "gold", "silver", or "crystal" -- gen1recomp-translation-mods'
-- own pipeline/shared/roms.py:verify_gs_rom()/verify_crystal_rom() already computed
