...
--
-- Usage: luajit tools/gsc/gate_package.lua <gen1recomp_root> <rby_mod_dir> <gold_mod_dir>

local engineRoot, rbyDir, goldDir = ...
if not engineRoot or engineRoot == "" or not rbyDir or rbyDir == "" or not goldDir or goldDir == "" then
  io.stderr:write("usage: luajit tools/gsc/gate_package.lua <gen1recomp_root> <rby_mod_dir> <gold_mod_dir>\n")
  os.exit(2)
end
...
-- tools/gsc/gate.lua and tools/gsc/gate_dialogue.lua use for a single
...
-- tools/gsc/gate.lua's loadFixture).
