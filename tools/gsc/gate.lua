...
--
-- Usage: luajit tools/gsc/gate.lua <gen1recomp_checkout_root> <fixtures_root>
...
if not engineRoot or engineRoot == "" or not fixturesRoot or fixturesRoot == "" then
  io.stderr:write("usage: luajit tools/gsc/gate.lua <gen1recomp_checkout_root> <fixtures_root>\n")
  os.exit(2)
end
...
local function loadFixture(name, generation)
  ...
  -- before the drive letter (e.g. "/C:\Users\...\tools/gsc/gate_fixtures\..."),
