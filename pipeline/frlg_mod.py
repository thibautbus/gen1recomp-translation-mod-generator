...
from .frlg_text import ir_plain, load_charmap, load_symbols
from .generate import lua_string
from .mod import TRANSLATION_MOD_PRIORITY
from .project import is_frozen, project_config, project_version, resource_root
from .roms import import_frlg_rom, verify_firered_rom
from .specs import game_spec, languages_for_collection, release_profile
...
def write_gate_expectations(path: Path, joined: dict) -> dict:
    """One sample per shipped catalog, read back by tools/gate_frlg.lua."""
...
def run_frlg_gate(
    ...
    *, log_fn: Callable[[str], None] | None = None,
    ...
    script = resource_root() / "tools" / "gate_frlg.lua"
    try:
