...
from ..shared.corpus import canonical_language, parse_redblue
...
from ..shared.project import ROOT, project_config
from ..shared.engine_profile import PINNED_PROFILE, UPSTREAM_PROFILE, checkout_revision, normalize_engine_profile
from .engine_scope import classify_catalog, load_scope, coverage_metadata
from ..shared.engine_manifest import engine_dynamic_values, forced_dynamic_keys
from .join import ENGINE_CATALOG_EXTRA_KEYS
from ..shared.strings_harvest import (
    _CALL_RE,
