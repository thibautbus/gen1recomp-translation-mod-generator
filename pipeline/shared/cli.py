...
from ..rby.mod import generate_mod
from .mod_assets import font_profile_warning
...
def main(argv=None) -> int:
    ...
    if args.command == "build-gs":
        from ..gsc.mod import build_gs_dialogue_mod
    ...
    if args.command == "frlg-hardcoded-strings":
        from ..frlg.audit import run_frlg_hardcoded_audit
