"""Shared streamed-subprocess execution for pipeline.shared.builder and pipeline.shared.roms.

A leaf module on purpose: pipeline.shared.builder imports pipeline.shared.roms (ROM
verification/import), so pipeline.shared.roms cannot import pipeline.shared.builder's own
